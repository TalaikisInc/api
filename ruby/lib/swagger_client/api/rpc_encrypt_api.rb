...
module SwaggerClient
  class RpcEncryptApi
    ...
    # @return [nil]
    def rpc_encrypt_post(args, opts = {})
      rpc_encrypt_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_encrypt_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcEncryptApi.rpc_encrypt_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcEncryptApi.rpc_encrypt_post"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcEncryptApi#rpc_encrypt_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
