...
module SwaggerClient
  class RpcUpdateUsersApi
    ...
    # @return [nil]
    def rpc_update_users_post(args, opts = {})
      rpc_update_users_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_update_users_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcUpdateUsersApi.rpc_update_users_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcUpdateUsersApi.rpc_update_users_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/update_users"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcUpdateUsersApi#rpc_update_users_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
