...
module SwaggerClient
  class RpcResetPasswordApi
    ...
    # @return [nil]
    def rpc_reset_password_post(args, opts = {})
      rpc_reset_password_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_reset_password_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcResetPasswordApi.rpc_reset_password_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcResetPasswordApi.rpc_reset_password_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/reset_password"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcResetPasswordApi#rpc_reset_password_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
