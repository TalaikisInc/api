...
module SwaggerClient
  class RpcDecryptIvApi
    ...
    # @return [nil]
    def rpc_decrypt_iv_post(args, opts = {})
      rpc_decrypt_iv_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_decrypt_iv_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcDecryptIvApi.rpc_decrypt_iv_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcDecryptIvApi.rpc_decrypt_iv_post"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcDecryptIvApi#rpc_decrypt_iv_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
