...
module SwaggerClient
  class RpcPgpSymEncryptByteaApi
    ...
    # @return [nil]
    def rpc_pgp_sym_encrypt_bytea_post(args, opts = {})
      rpc_pgp_sym_encrypt_bytea_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_pgp_sym_encrypt_bytea_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcPgpSymEncryptByteaApi.rpc_pgp_sym_encrypt_bytea_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcPgpSymEncryptByteaApi.rpc_pgp_sym_encrypt_bytea_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/pgp_sym_encrypt_bytea"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcPgpSymEncryptByteaApi#rpc_pgp_sym_encrypt_bytea_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
