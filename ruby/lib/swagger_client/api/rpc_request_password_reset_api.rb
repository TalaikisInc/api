...
module SwaggerClient
  class RpcRequestPasswordResetApi
    ...
    # @return [nil]
    def rpc_request_password_reset_post(args, opts = {})
      rpc_request_password_reset_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_request_password_reset_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcRequestPasswordResetApi.rpc_request_password_reset_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcRequestPasswordResetApi.rpc_request_password_reset_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/request_password_reset"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcRequestPasswordResetApi#rpc_request_password_reset_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
