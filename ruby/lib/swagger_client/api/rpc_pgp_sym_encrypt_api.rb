...
module SwaggerClient
  class RpcPgpSymEncryptApi
    ...
    # @return [nil]
    def rpc_pgp_sym_encrypt_post(args, opts = {})
      rpc_pgp_sym_encrypt_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_pgp_sym_encrypt_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcPgpSymEncryptApi.rpc_pgp_sym_encrypt_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcPgpSymEncryptApi.rpc_pgp_sym_encrypt_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/pgp_sym_encrypt"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcPgpSymEncryptApi#rpc_pgp_sym_encrypt_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
