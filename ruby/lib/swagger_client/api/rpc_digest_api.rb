...
module SwaggerClient
  class RpcDigestApi
    ...
    # @return [nil]
    def rpc_digest_post(args, opts = {})
      rpc_digest_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_digest_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcDigestApi.rpc_digest_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcDigestApi.rpc_digest_post"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcDigestApi#rpc_digest_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
