...
module SwaggerClient
  class RpcGenRandomUuidApi
    ...
    # @return [nil]
    def rpc_gen_random_uuid_post(args, opts = {})
      rpc_gen_random_uuid_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_gen_random_uuid_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcGenRandomUuidApi.rpc_gen_random_uuid_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcGenRandomUuidApi.rpc_gen_random_uuid_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/gen_random_uuid"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcGenRandomUuidApi#rpc_gen_random_uuid_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
