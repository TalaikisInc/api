...
module SwaggerClient
  class RpcPgpArmorHeadersApi
    ...
    # @return [nil]
    def rpc_pgp_armor_headers_post(args, opts = {})
      rpc_pgp_armor_headers_post_with_http_info(args, opts)
      return nil
    end
    ...
    def rpc_pgp_armor_headers_post_with_http_info(args, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RpcPgpArmorHeadersApi.rpc_pgp_armor_headers_post ..."
      end
      # verify the required parameter 'args' is set
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling RpcPgpArmorHeadersApi.rpc_pgp_armor_headers_post"
      end
      ...
      # resource path
      local_var_path = "/rpc/pgp_armor_headers"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RpcPgpArmorHeadersApi#rpc_pgp_armor_headers_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
