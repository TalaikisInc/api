...
type RpcGenRandomBytesApiService service


/* RpcGenRandomBytesApiService 
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param args 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "prefer" (string) Preference
 @return */
func (a *RpcGenRandomBytesApiService) RpcGenRandomBytesPost(ctx context.Context, args interface{}, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/gen_random_bytes"
