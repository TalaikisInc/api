 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *ContractsApiService) ContractsDelete(ctx context.Context, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	if err := typeCheckParameter(localVarOptionals["bytecode"], "string", "bytecode"); err != nil {
		return nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["bytecode"].(string); localVarOk {
		localVarQueryParams.Add("bytecode", parameterToString(localVarTempParam, ""))
	}
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "prefer" (string) Preference
 @return Contracts*/
func (a *ContractsApiService) ContractsGet(ctx context.Context, localVarOptionals map[string]interface{}) (Contracts,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Contracts
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "prefer" (string) Preference
 @return */
func (a *ContractsApiService) ContractsPatch(ctx context.Context, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["contracts"].(Contracts); localVarOk {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "prefer" (string) Preference
 @return */
func (a *ContractsApiService) ContractsPost(ctx context.Context, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
