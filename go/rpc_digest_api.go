...
type RpcDigestApiService service
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *RpcDigestApiService) RpcDigestPost(ctx context.Context, args interface{}, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/digest"
