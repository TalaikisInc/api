...
type RpcSignupApiService service
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *RpcSignupApiService) RpcSignupPost(ctx context.Context, args Args1, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/signup"
