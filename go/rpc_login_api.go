...
type RpcLoginApiService service
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *RpcLoginApiService) RpcLoginPost(ctx context.Context, args Args3, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/login"
