...
type RpcPgpSymEncryptApiService service


/* RpcPgpSymEncryptApiService 
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param args 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "prefer" (string) Preference
 @return */
func (a *RpcPgpSymEncryptApiService) RpcPgpSymEncryptPost(ctx context.Context, args interface{}, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/pgp_sym_encrypt"
