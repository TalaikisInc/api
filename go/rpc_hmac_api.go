...
type RpcHmacApiService service
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *RpcHmacApiService) RpcHmacPost(ctx context.Context, args interface{}, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/hmac"
