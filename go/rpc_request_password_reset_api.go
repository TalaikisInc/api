...
type RpcRequestPasswordResetApiService service


/* RpcRequestPasswordResetApiService 
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param args 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "prefer" (string) Preference
 @return */
func (a *RpcRequestPasswordResetApiService) RpcRequestPasswordResetPost(ctx context.Context, args Args2, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/request_password_reset"
