 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *BlocksApiService) BlocksDelete(ctx context.Context, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "prefer" (string) Preference
 @return Blocks*/
func (a *BlocksApiService) BlocksGet(ctx context.Context, localVarOptionals map[string]interface{}) (Blocks,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Blocks
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "prefer" (string) Preference
 @return */
func (a *BlocksApiService) BlocksPatch(ctx context.Context, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["blocks"].(Blocks); localVarOk {
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "prefer" (string) Preference
 @return */
func (a *BlocksApiService) BlocksPost(ctx context.Context, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
