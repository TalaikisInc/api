...
type RpcResetPasswordApiService service


/* RpcResetPasswordApiService 
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param args 
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "prefer" (string) Preference
 @return */
func (a *RpcResetPasswordApiService) RpcResetPasswordPost(ctx context.Context, args Args, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rpc/reset_password"
