...
module SwaggerClient
  class ContractsApi
    ...
    # @return [nil]
    def contracts_delete(opts = {})
      contracts_delete_with_http_info(opts)
      return nil
    end
    ...
    def contracts_delete_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContractsApi.contracts_delete ..."
      end
      ...
      query_params[:'bytecode'] = opts[:'bytecode'] if !opts[:'bytecode'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContractsApi#contracts_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def contracts_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContractsApi.contracts_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContractsApi#contracts_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :prefer Preference
    # @return [nil]
    def contracts_patch(opts = {})
      contracts_patch_with_http_info(opts)
      return nil
    end
    ...
    # @option opts [String] :prefer Preference
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def contracts_patch_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContractsApi.contracts_patch ..."
      end
      if @api_client.config.client_side_validation && opts[:'prefer'] && !['return=representation', 'return=minimal', 'return=none'].include?(opts[:'prefer'])
        fail ArgumentError, 'invalid value for "prefer", must be one of return=representation, return=minimal, return=none'
      end
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'contracts'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContractsApi#contracts_patch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :prefer Preference
    # @return [nil]
    def contracts_post(opts = {})
      contracts_post_with_http_info(opts)
      return nil
    end
    ...
    # @option opts [String] :prefer Preference
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def contracts_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ContractsApi.contracts_post ..."
      end
      if @api_client.config.client_side_validation && opts[:'prefer'] && !['return=representation', 'return=minimal', 'return=none'].include?(opts[:'prefer'])
        fail ArgumentError, 'invalid value for "prefer", must be one of return=representation, return=minimal, return=none'
      end
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContractsApi#contracts_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
